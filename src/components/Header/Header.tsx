...
function Header() {
  ...
  return (
    <header className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2'>
      <div className=' mx-14  '>
        <nav className='mx-80 flex justify-end text-gray-50 '>
          <Popover
            renderPopover={
      ...
      {/* nar search */}
      <div className='mt-4 grid grid-cols-12 items-end gap-4 sm:gap-2 lg:gap-4'>
        <div className='col-span-1 col-start-3 '>
          <NavLink to={'/'}>
            <svg viewBox='0 0 192 65' className='h-12 w-40 fill-white  pr-10 '>
              <g>
