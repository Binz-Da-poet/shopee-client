                ...
                <div className='relative w-52 rounded-sm border border-t-0 border-gray-200 bg-white shadow-md'>
                  <div className='flex flex-col py-2 px-3 text-black'>
                    <button className='py-2 px-3 hover:bg-slate-50 hover:text-orange'>
                      <NavLink to='/productDetail'>tài khoản của tôi</NavLink>
                    </button>
                    {isAdminRole ? (
            ...
            >
              <div className='flex cursor-pointer items-center  py-1 hover:text-gray-300 '>
                <div className='mr-2 h-6 w-6 flex-shrink-0'>
                  <img
                    src={profile?.avatar || 'src/assets/avatarDefault.png'}
                    alt='AVATAR'
          ...
          renderPopover={
            <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm  shadow-md'>
                ...
                <div className='mt-5'>
                  <div className='mt-4 flex hover:bg-slate-50'>
                    <div className='flex-shrink-0'>
                      <img
                        src='https://down-vn.img.susercontent.com/file/2ff7f2fdd85a06476f20b6c95f020c91_tn'
                        alt='anh'
                        className='h-11 w-11 object-cover'
                      />
                    </div>
                    <div className='ml-2 flex-grow overflow-hidden'>
                      <div className='truncate'>Da heo mắm hành 140g DumBum đồ ăn vặt Hà Nội vừa ngon vừa rẻ</div>
                    </div>
              ...
              <div className='mt-6 flex items-center justify-between'>
                ...
                <NavLink to='/' className='rounded-sm bg-orange px-4 py-2 capitalize text-white hover:bg-opacity-90'>
                  Xem giỏ hàng
                </NavLink>
              </div>
            </div>
